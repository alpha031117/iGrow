...
function readStoredDashSimCount() {
  const parsed = Number.parseInt(
    localStorage.getItem(DASH_SIM_COUNT_KEY) ?? "0",
    10,
  );
...
const DATA: Record<string, PeriodData> = {
  thisWeek: {
    ...
    heroLabel: "Weekly Sales",
    heroSales: 1440,
    heroTxn: 218,
    heroAvg: 6.61,
    vsPrev: 14,
    vsPrevLabel: "vs last week",
    summary: {
      total: "RM 1,440",
      avg: "RM 206 / day",
      bestDay: "Friday — RM 342",
      vsPrev: "+14%",
      up: true,
    },
    days: [
    ...
    tip: {
      ...
      title: "Smart Insight",
      color: C.pri,
      bg: `linear-gradient(135deg,${C.priBg},#fff)`,
      border: C.priMuted,
      body: "Your Friday + Saturday sales make up <strong>52%</strong> of weekly income. Consider stocking 20% more on these days.",
    },
    monthEarned: "RM 4,320",
    monthPace: "RM 5,760",
    monthPct: 75,
    monthLabel: "earned so far in April",
    weeks: [
      { w: "Week 1", v: 980 },
      { w: "Week 2", v: 1120 },
      { w: "Week 3", v: 1260 },
    ...
    health: {
      icon: "🌱",
      title: "Growing Steady",
      color: C.grn,
      bg: `linear-gradient(135deg,${C.grnBg},#fff)`,
      border: "#a7f3d0",
      body: "Income up for <strong>3 weeks straight</strong>. Keep this pace!",
    },
  },
  lastWeek: {
    ...
    heroAvg: 6.49,
    vsPrev: 12,
    vsPrevLabel: "vs week before",
    summary: {
      total: "RM 1,260",
      avg: "RM 180 / day",
      bestDay: "Saturday — RM 298",
      vsPrev: "+12%",
      up: true,
    },
    days: [
    ...
    tip: {
      ...
      bg: `linear-gradient(135deg,${C.priBg},#fff)`,
      border: C.priMuted,
      body: "Saturday was your top earner. The 7–9 PM slot brought <strong>58%</strong> of total sales.",
    },
    monthEarned: "RM 4,320",
    monthPace: "RM 5,760",
    monthPct: 75,
    ...
    health: {
      ...
      title: "Solid Week",
      color: C.blu,
      bg: `linear-gradient(135deg,${C.bluBg},#fff)`,
      border: "#93c5fd",
      body: "You earned <strong>12% more</strong> than the week before.",
    },
  },
  customWeek: {
    ...
    tip: {
      ...
      bg: `linear-gradient(135deg,${C.priBg},#fff)`,
      border: C.priMuted,
      body: "In your selected period, <strong>weekends</strong> contributed the most revenue.",
    },
    monthEarned: null,
    monthPace: null,
    monthPct: 0,
    ...
    health: {
      ...
      bg: `linear-gradient(135deg,${C.priBg},#fff)`,
      border: C.priMuted,
      body: "Showing data for your selected date range.",
    },
  },
  thisMonth: {
    ...
    heroAvg: 6.43,
    vsPrev: 9,
    vsPrevLabel: "vs March",
    summary: {
      total: "RM 4,320",
      avg: "RM 216 / day",
      bestDay: "Fridays — avg RM 310",
      vsPrev: "+9%",
      up: true,
    },
    days: [
    ...
    tip: {
      ...
      bg: `linear-gradient(135deg,${C.priBg},#fff)`,
      border: C.priMuted,
      body: "Averaging <strong>RM 216/day</strong>. Fridays outperform by 40%.",
    },
    monthEarned: "RM 4,320",
    monthPace: "RM 5,760",
    monthPct: 75,
    ...
    health: {
      ...
      bg: `linear-gradient(135deg,${C.grnBg},#fff)`,
      border: "#a7f3d0",
      body: "On track for your <strong>best month yet</strong>.",
    },
  },
  lastMonth: {
    ...
    heroAvg: 6.35,
    vsPrev: -3,
    vsPrevLabel: "vs February",
    summary: {
      total: "RM 3,960",
      avg: "RM 198 / day",
      bestDay: "Saturdays — avg RM 285",
      vsPrev: "-3%",
      up: false,
    },
    days: [
    ...
    tip: {
      ...
      bg: `linear-gradient(135deg,${C.priBg},#fff)`,
      border: C.priMuted,
      body: "March dipped due to <strong>weaker Mon–Tue</strong>. Weekends stayed strong.",
    },
    monthEarned: "RM 3,960",
    monthPace: null,
    monthPct: 100,
    monthLabel: "total for March 2026",
    weeks: [
      { w: "Week 1", v: 920 },
      { w: "Week 2", v: 1040 },
      { w: "Week 3", v: 1020 },
    ...
    health: {
      ...
      title: "Slight Dip",
      color: C.warn,
      bg: `linear-gradient(135deg,${C.warnBg},#fff)`,
      border: "#fde68a",
      body: "March was <strong>3% below</strong> February.",
    },
  },
  customMonth: {
    periodLabel: "Custom Range",
...
function DetailRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex items-start justify-between gap-2">
      <span className="text-[11px] font-semibold text-[#6B7280] uppercase tracking-wide shrink-0">
        {label}
      </span>
      <span className="text-[12px] font-medium text-[#0D2B6E] text-right">
        {value}
      </span>
    </div>
  );
...
function InsightSkeleton() {
  return (
    <div className="space-y-2 mt-1">
      ...
      <div
        className="h-2.5 rounded-full animate-pulse"
        style={{ backgroundColor: "#E2E8F0", width: "70%" }}
      />
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-[#0D2B6E] text-[18px] font-bold leading-snug mb-1">
          One step to unlock more
        </h2>
        <p className="text-gray-500 text-[13px] leading-relaxed mb-4">
          Your revenue pattern looks great. To qualify for financing and
          incubator programs, you&apos;ll need an SSM registration first.
        </p>
        <div className="bg-[#EEF2FB] rounded-2xl p-4 mb-4">
          <p className="text-[#0D2B6E] text-[12px] font-bold mb-3">
            With SSM, you can access:
          </p>
          <div className="flex flex-col gap-2.5">
            {[
              {
                icon: Banknote,
                label: "Starter Track Package B",
                sub: "RM 10,000 – RM 50,000 revenue-based financing",
              },
              {
                icon: Sparkles,
                label: "Growth Track programs",
                sub: "MDEC grants, TEKUN financing, incubator matching",
              },
              ...
              <div key={label} className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-[13px] font-semibold text-[#0D2B6E]">
                    {label}
                  </p>
        ...
        >
          <span className="text-[12px] text-amber-700 leading-relaxed">
            <span className="font-bold">SSM registration</span> costs from RM 30
            for sole proprietors and can be done online at{" "}
            <span className="font-semibold">ssm.com.my</span>.
          </span>
        </div>
        <button
          onClick={onChat}
        ...
        >
          <ExternalLink className="w-4 h-4" /> Ask AlphaGrow how to register SSM
        </button>
        <button
          onClick={onDismiss}
...
function LaunchpadNudgeSheet({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-lg bg-white rounded-t-3xl px-5 pt-5 pb-8 shadow-2xl overflow-y-auto max-h-[92vh]"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="w-10 h-1 rounded-full bg-gray-200 mx-auto mb-5" />
        <div className="flex items-center gap-2 mb-4">
          ...
          <div>
            <h2 className="text-[#0D2B6E] text-[17px] font-bold leading-snug">
              You&apos;re ready for Launchpad
            </h2>
            <p className="text-[11px] text-gray-400">
              AlphaGrow Analytics Engine · merchant profile analysis
            </p>
          </div>
        </div>
        ...
        <div className="bg-[#EEF2FB] rounded-2xl p-3 mb-3">
          <div className="grid grid-cols-3 gap-2">
            {[
              {
                value: `RM ${totalSimRevenue.toLocaleString()}`,
                label: "Revenue signal",
              },
              { value: `+${wowGrowth}%`, label: "Week-over-week" },
              {
                value: `${bestSimDay.d} RM ${bestSimDay.v}`,
                label: "Best day",
              },
            ].map(({ value, label }) => (
              <div
                key={label}
                className="bg-white rounded-xl px-2 py-2.5 flex flex-col items-center text-center"
              >
                <span className="text-[#0D2B6E] text-[14px] font-extrabold leading-tight">
                  {value}
                </span>
        ...
        <div className="flex items-center gap-2 mb-4">
          <div className="flex-1 h-1.5 rounded-full bg-[#E5EBF8] overflow-hidden">
            <div
              ...
              style={{
                width: `${matchScore}%`,
                background: "linear-gradient(90deg, #1A5FD5, #2B7BE5)",
              }}
            />
          </div>
          <span className="text-[11px] font-bold text-[#1A5FD5] shrink-0">
            {matchScore}% match
          </span>
        </div>

        <p className="text-gray-500 text-[13px] leading-relaxed mb-3">
          Based on your revenue pattern and business profile, you may be
          eligible for:
        </p>
        <div className="bg-[#EEF2FB] rounded-2xl p-4 mb-5">
          {tier === "1" ? (
            <>
              <p className="text-[#1A5FD5] text-[11px] font-bold uppercase tracking-wide mb-0.5">
                Starter Track
              </p>
              <p className="text-[#0D2B6E] text-[15px] font-bold mb-1">
                {pkg === "A"
                  ? "Package A — Solo Operator"
                  : "Package B — Growing SME"}
              </p>
              <p className="text-gray-500 text-[12px] mb-3">
                {pkg === "A"
                  ? "For solo hustlers. Start small, grow steady."
                  : "For businesses ready for their next chapter."}
              </p>
              <div className="flex flex-col gap-2">
                ...
                <DetailRow
                  ...
                  value="6.02% of monthly TNG revenue"
                />
                <DetailRow
                  label="Repayment"
                  value="No fixed monthly instalments"
                />
              </div>
            </>
          ) : (
            <>
              ...
              <p className="text-gray-500 text-[12px] mb-3">
                Get matched with grants, programs, and investors.
              </p>
              <div className="flex flex-wrap gap-1.5">
                {partners.slice(0, 3).map((p) => (
                  <span
                    key={p.abbr}
                    className="text-[11px] font-semibold px-2.5 py-1 rounded-full bg-white text-[#0D2B6E]"
                  >
                    {p.name}
                  </span>
                ))}
                <span className="text-[11px] font-semibold px-2.5 py-1 rounded-full bg-white text-[#6B7280]">
                  +{partners.length - 3} more
                </span>
              </div>
              <p className="text-[11px] text-[#1A5FD5] font-medium mt-3">
                TNG pre-fills your application using your merchant data.
              </p>
            </>
          )}
        </div>
        ...
        <p className="text-center text-[11px] text-gray-400 mt-4 leading-relaxed">
          This is not a loan approval. TNG Launchpad products are subject to
          eligibility review.
        </p>
      </div>
    </div>
    ...
    >
      <div className="w-full max-w-lg bg-white rounded-t-3xl px-5 pt-6 pb-8 shadow-2xl">
        ...
        <div className="flex items-center gap-3 mb-5">
          ...
          <div>
            <p className="text-[#0D2B6E] text-[15px] font-bold leading-snug">
              AlphaGrow Analytics Engine
            </p>
            <p className="text-[11px] text-gray-400">
              Analysing your merchant profile…
            </p>
          </div>
        </div>
        ...
        <p className="text-center text-[11px] text-gray-400 mt-5 leading-relaxed">
          Powered by TNG AlphaGrow Launchpad
        </p>
      </div>
    </div>
  );
...
function ReportSheet({
  ...
  async function genPDF(type: "weekly" | "monthly" | "annual") {
    ...
    d.days.forEach((day, i) => {
      ...
      doc.text(`RM ${day.v}`, x + bw / 2, barBaseY - bH - 2, {
        align: "center",
      });
    ...
    doc.setFontSize(8);
    doc.setFont("helvetica", "bold");
    doc.setTextColor(26, 95, 213);
    doc.text(
      `Peak: ${d.peakHour} (${d.peakShare})  |  Arrive by ${d.arriveBy}`,
      M + 4,
      y + 6.5,
    );
    y += 18;
    ...
    doc.text("AlphaGrow Insight", M + 6, y + 7);
    doc.setFont("helvetica", "normal");
    doc.setFontSize(8);
    doc.setTextColor(100, 116, 139);
    ...
    doc.text("Generated by AlphaGrow · Powered by TNG", W / 2, 285, {
      align: "center",
    });
    doc.save(
      `AlphaGrow-${tl.replace(" ", "-")}-${new Date().toISOString().slice(0, 10)}.pdf`,
    );
  ...
  const opts = [
    {
      key: "weekly" as const,
      label: "Weekly Report",
      desc: "7-day summary with daily breakdown & tips",
      badge: "W",
      badgeBg: C.priBg,
      badgeColor: C.pri,
    },
    {
      ...
      desc: "30-day overview with weekly trends & insights",
      badge: "M",
      badgeBg: C.grnBg,
      badgeColor: C.grn,
    },
    {
      key: "annual" as const,
      label: "Annual Report",
      desc: "12-month performance with growth trajectory",
      badge: "Y",
      badgeBg: C.bluBg,
      badgeColor: C.blu,
    },
    ...
    <>
      ...
      >
        <div
          ...
          style={{ backgroundColor: C.g300 }}
        />
        <p
          className="text-[18px] font-bold mb-1"
          style={{ color: C.g900, letterSpacing: "-0.3px" }}
        >
          Generate Report
        </p>
        <p
          ...
          style={{ color: C.g500 }}
        >
          Download a PDF summary of your business performance.
        </p>
        ...
        {opts.map((o) => {
          ...
          return (
            ...
            >
              <div
                className="w-11 h-11 rounded-xl flex items-center justify-center text-[18px] font-bold shrink-0"
                style={{ backgroundColor: o.badgeBg, color: o.badgeColor }}
              >
                {o.badge}
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-[14px] font-bold" style={{ color: C.g900 }}>
                  {o.label}
                </p>
                <p
      ...
      {toast && (
        <div
          className="fixed bottom-24 left-1/2 -translate-x-1/2 z-[200] flex items-center gap-2 px-5 py-3 rounded-2xl shadow-xl text-[13px] font-semibold text-white"
...
export default function DashboardPage() {
  ...
  const aiRecRef = useRef<Record<string, unknown> | null | undefined>(
    undefined,
  );
  ...
  const [aiInsights, setAiInsights] = useState<
    Record<
      string,
      {
        tip: { title: string; body: string; icon: string };
        health: { title: string; body: string; icon: string };
      }
    >
  >({});
  ...
  useEffect(() => {
    const loadState = () => {
      ...
      const accepted =
        localStorage.getItem("igrow_launchpad_accepted") === "true";
      setLaunchpadAccepted(accepted);

      const savedTier = localStorage.getItem("igrow_tier") as "1" | "2" | null;
      const savedPkg = localStorage.getItem("igrow_package") as
        | "A"
        | "B"
        | "track1"
        | "track2"
      ...
      const simCompleted =
        localStorage.getItem(DASH_SIM_COMPLETED_KEY) === "true";
      if (simCompleted && savedCount >= DASH_SIM_THRESHOLD && !accepted) {
        const userHasSSM =
          localStorage.getItem("igrow_ssm") === "Yes, I have SSM";
        if (!userHasSSM) {
  ...
  function runOneDashSimTick() {
    ...
    if (next >= DASH_SIM_THRESHOLD) {
      ...
      if (!userHasSSM) {
        ...
        fetch(
          `/api/recommend-program?hasSSM=false&category=${encodeURIComponent(cat)}`,
        )
      ...
      const cat = localStorage.getItem("igrow_category") ?? "";
      fetch(
        `/api/recommend-program?hasSSM=true&category=${encodeURIComponent(cat)}`,
      )
        .then((r) => (r.ok ? r.json() : null))
        .then((data) => {
          aiRecRef.current = data ?? null;
          ...
          if (stepsCompleteRef.current)
            finalizeRecommendation(aiRecRef.current ?? null);
        })
        .catch(() => {
          aiRecRef.current = null;
  ...
  function finalizeRecommendation(rec: Record<string, unknown> | null) {
    ...
    const pkg: "A" | "B" | "track1" | "track2" =
      (rec?.recommendedPackage as "A" | "B" | "track1" | "track2") ??
      (isFood ? "B" : "track2");
  ...
  function handleStartDashSimulate() {
    if (
      simRunning ||
      launchpadAccepted ||
      dashSimCountRef.current >= DASH_SIM_THRESHOLD
    )
      return;
    setSimRunning(true);
  ...
  const activePeakHour = activeSimDayData
    ? activeSimDayData.peakHour
    : d.peakHour;
  const activePeakShare = activeSimDayData
    ? activeSimDayData.peakShare
    : d.peakShare;
  const activeArriveBy = activeSimDayData
    ? activeSimDayData.arriveBy
    : d.arriveBy;
  ...
  async function fetchInsights(key: string) {
    ...
    const periodData = (
      liveData[key]
        ? { ...(DATA[key] ?? DATA.thisWeek), ...liveData[key] }
        : (DATA[key] ?? DATA.thisWeek)
    ) as PeriodData;
    if (!periodData) {
    ...
    const weekTrend =
      periodData.weeks
        .map((w: { w: string; v: number }) => `${w.w}:${w.v}`)
        .join(", ") || "no data";
    const payload = {
  ...
  }, [activeTab, weekFilter, monthFilter]);
  ...
  const bestSimDay = DASH_SIM_DATA.reduce((best, dd) =>
    dd.v > best.v ? dd : best,
  );
  ...
  const matchScore: number =
    (aiRec?.matchScore as number) ??
    Math.min(60 + (hasSSM ? 15 : 0) + (wowGrowth > 0 ? 10 : 0) + 7, 97);
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: `linear-gradient(145deg,${C.pri},${C.priDark})` }}
      >
        <div
        ...
        <div className="relative z-10 max-w-2xl mx-auto flex justify-between items-start">
          <div>
            ...
            <p className="text-[24px] font-extrabold mt-0.5 tracking-tight text-white">
              Brisval
            </p>
            <p
      ...
      <div className="mt-4 bg-white rounded-2xl p-1.5 flex relative shadow-sm">
        <div
          ...
          style={{
            ...
            transform: `translateX(${activeTab === "month" ? "100%" : "0"})`,
          }}
        />
      ...
      {launchpadAccepted &&
        ...
        (() => {
          const tier1Signals = [
            {
              label: `RM ${((totalSimRevenue / 2) * 0.0602).toFixed(0)}/mo est. deduction`,
              sub: "6.02% of your TNG monthly revenue",
            },
            {
              label: "No fixed instalments",
              sub: "Repayment scales with your income",
            },
            {
              label: `${totalSimTxn} transactions recorded`,
              sub: "Strong transaction history for eligibility",
            },
            {
              label: "Revenue-based eligibility",
              sub: "No SSM barrier for Package A",
            },
          ];
          const tier2Signals = [
            {
              label: "SSM Registered",
              sub: "Eligible for Growth Track financing",
            },
            {
              label: bizCategory,
              sub: "Aligned with Digital Commerce programs",
            },
            {
              label: `+${wowGrowth}% week-over-week`,
              sub: "Consistent upward revenue trend",
            },
            {
              label: "Peak 7–9 PM pattern",
              sub: "Strong evening customer engagement",
            },
          ];
          ...
          return (
            <Card id="launchpad-card">
              ...
              <div className="bg-[#EEF2FB] rounded-2xl p-4 mb-4">
                <p className="text-[11px] font-bold uppercase tracking-wide text-[#1A5FD5] mb-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {[
                    ...
                    {
                      value: `RM ${avgTxnValue.toFixed(2)}`,
                      label: "Avg per transaction",
                    },
                  ].map(({ value, label }) => (
                    <div key={label} className="bg-white rounded-xl p-3">
                      <p className="text-[15px] font-extrabold text-[#0D2B6E] leading-tight">
                        {value}
                      </p>
              ...
              <div className="flex flex-col gap-2 mb-4">
                {signals.map(({ label, sub }) => (
                  <div key={label} className="flex items-start gap-2.5">
                    ...
                    <div>
                      <p className="text-[13px] font-semibold text-[#0D2B6E] leading-snug">
                        {label}
                      </p>
                      <p className="text-[11px] text-gray-400">{sub}</p>
                    </div>
                ...
                <>
                  <div className="bg-[#EEF2FB] rounded-2xl p-3 flex flex-col gap-2 mb-3">
                    ...
                    <DetailRow
                      ...
                      value="3+ months below floor — restructure support"
                    />
                  </div>
                  <button
                  ...
                  >
                    <span className="text-[#0D2B6E] text-[13px] font-semibold">
                ...
                <>
                  ...
                  >
                    <span className="text-[11px] text-[#1A5FD5] font-medium leading-snug">
                      TNG pre-fills your application form using your merchant
                      data.
                    </span>
                  </div>
                  <button
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
        <div className="bg-white rounded-[20px] p-5 shadow-sm relative overflow-hidden">
          <div
            ...
            style={{
              background: `linear-gradient(135deg,rgba(26,95,213,.08),transparent)`,
            }}
          />
          <p
          ...
          >
            {currentDashSimCount > 0
              ? `${currentDashSimCount}-Day Revenue`
              : d.heroLabel}
          </p>
          <p
            className="text-[26px] font-extrabold my-1.5 tracking-tight"
            style={{ color: C.g900 }}
          >
          ...
          {currentDashSimCount > 0 ? (
            <span
              ...
              style={{ color: C.grn, backgroundColor: C.grnBg }}
            >
            ...
            <span
              className="inline-flex items-center gap-1 text-[12px] font-semibold px-2 py-0.5 rounded-lg"
              style={{
                color: d.vsPrev >= 0 ? C.grn : C.red,
                backgroundColor: d.vsPrev >= 0 ? C.grnBg : C.redBg,
              }}
            >
              {d.vsPrev >= 0 ? (
        ...
        <div className="bg-white rounded-[20px] p-5 shadow-sm relative overflow-hidden">
          ...
          <span
            className="inline-flex items-center text-[12px] font-semibold px-2 py-0.5 rounded-lg"
            style={{ color: C.g500, backgroundColor: C.g100 }}
          >
      ...
      <Card>
        {[
          ...
          <div
            key={i}
            className={`flex justify-between items-center py-2.5 ${i > 0 ? "border-t" : ""}`}
        ...
        {d.summary.vsPrev !== "—" && (
          <div
            className="flex justify-between items-center py-2.5 border-t"
            style={{ borderColor: C.g100 }}
          >
            <span
              className="text-[13.5px] font-medium"
            ...
            <span
              ...
              style={{
                color: d.summary.up ? C.grn : C.red,
                backgroundColor: d.summary.up ? C.grnBg : C.redBg,
              }}
            >
              {d.summary.up ? (
                <TrendingUp className="w-3 h-3" />
          ...
          {chartDays.map((x, i) => {
            ...
            return (
              <div
                ...
                onClick={() => {
                  if (!isEmpty)
                    setActiveBarIdx((prev) => (prev === i ? null : i));
                }}
              >
                <div
                  ...
                  style={{
                    ...
                    background: isEmpty
                      ? C.g100
                      : isActiveBar
                        ? `linear-gradient(180deg,${C.pri},${C.priDark})`
                        : C.g200,
                ...
                >
                  {!isEmpty && (
                    <span
                      className={`absolute -top-5 left-1/2 -translate-x-1/2 text-[10px] font-bold whitespace-nowrap transition-opacity ${isActiveBar ? "opacity-100" : "opacity-0 group-hover:opacity-100"}`}
                ...
                <span
                  ...
                  style={{ color: isActiveBar ? C.pri : C.g400 }}
                >
                  {x.d}
                </span>
              </div>
      ...
      <div className="flex items-center justify-between pb-2.5 pt-1">
        ...
        {selectedDayLabel && (
          <span
            ...
            style={{ backgroundColor: C.priBg, color: C.pri }}
          >
            {selectedDayLabel}
          </span>
        )}
      ...
      <Card>
          ...
          {activeHours.map((h, i) => {
            ...
            return (
              <div
                ...
                style={{ backgroundColor: isPeak ? C.priBg : "transparent" }}
              >
                <span
                  className="w-14 text-[11.5px] font-semibold shrink-0"
                  style={{ color: isPeak ? C.pri : C.g500 }}
                >
                  {h.t}
                </span>
                <div
                ...
                >
                  <div
                    ...
                    style={{
                      width: `${Math.max(h.pct, 4)}%`,
                      background: phBarColor(h.pct),
                    }}
                  />
                </div>
                <span
                  className="w-9 text-right text-[12px] font-bold shrink-0"
                  style={{ color: isPeak ? C.pri : C.g400 }}
                >
                  {h.pct}%
                </span>
                {isPeak && (
                  <span
                    ...
                    style={{
                      color: C.pri,
                      backgroundColor: `rgba(26,95,213,.1)`,
                    }}
                  >
                    PEAK
                  </span>
        ...
        <div
          className="flex items-center gap-2 mt-3.5 px-3.5 py-3 rounded-xl text-[12.5px] font-semibold leading-snug"
          style={{ backgroundColor: C.priBg, color: C.pri }}
        >
          <Clock className="w-4 h-4 shrink-0 opacity-70" />
          <span>
            Peak: <strong>{activePeakHour}</strong> ({activePeakShare}) · Arrive
            by {activeArriveBy}
          </span>
        </div>
      </Card>
      ...
      <div className="mb-4">
        <div
          ...
          style={{
            background: activeTip.bg,
            border: `1px solid ${activeTip.border}`,
          }}
        >
          <div
            ...
            <div className="flex items-center gap-2 mb-0.5">
              ...
              {isAiActive && !insightsLoading && (
                <span
                  ...
                  style={{
                    backgroundColor: activeTip.color + "18",
                    color: activeTip.color,
                  }}
                >
                  ✨ AI
                </span>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[13px] mt-1">
                ...
                <span className="font-bold" style={{ color: C.pri }}>
                  {d.monthPace}
                </span>
        ...
        <Card>
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[13px] mt-0.5" style={{ color: C.g500 }}>
                {d.monthLabel}
              </p>
            </div>
          </div>
        ...
        <>
          ...
          <Card>
            {weeks.map((wk, i) => {
              ...
              const delta =
                i > 0
                  ? Math.round(((wk.v - weeks[i - 1].v) / weeks[i - 1].v) * 100)
                  : null;
              return (
                <div
                  key={i}
                  className={`${i < weeks.length - 1 ? "mb-3.5" : ""}`}
                >
                  <div className="flex justify-between mb-1.5">
                    ...
                    <span
                      ...
                      style={{ color: isLast ? C.pri : C.g700 }}
                    >
                      RM {wk.v.toLocaleString()}
                      {delta !== null && (
                        <span
                          className="ml-1.5 text-[10px] font-semibold"
                          style={{ color: delta >= 0 ? C.grn : C.red }}
                        >
                          {delta >= 0 ? "+" : ""}
                          {delta}%
                        </span>
                  ...
                  >
                    <div
                      ...
                      style={{
                        width: `${pct}%`,
                        background: isLast
                          ? `linear-gradient(90deg,${C.pri},${C.priLight})`
                          : C.g200,
                      }}
                    />
                  </div>
      ...
      <div className="mb-4">
        <div
          className="rounded-[20px] p-5 flex gap-3.5 items-start"
          style={{
            background: activeHealth.bg,
            border: `1px solid ${activeHealth.border}`,
          }}
        >
          <div
            className="w-10 h-10 rounded-xl flex items-center justify-center text-[18px] shrink-0"
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-0.5">
              <p
                className="text-[12px] font-bold"
                style={{ color: activeHealth.color }}
              >
              ...
              {isAiActive && !insightsLoading && (
                <span
                  className="text-[9px] font-bold px-1.5 py-0.5 rounded-full"
                  style={{
                    backgroundColor: activeHealth.color + "18",
      ...
      <p
        className="text-center text-[11px] font-medium pb-4"
        style={{ color: C.g400 }}
      >
        ...
        <SsmNudgeSheet
          ...
          onChat={() => {
            ...
            router.push(
              "/chat?prompt=" +
                encodeURIComponent(
                  "How do I register my business with SSM in Malaysia? I'm a small business owner using TNG and want to access financing packages.",
                ),
            );
          }}
        />
