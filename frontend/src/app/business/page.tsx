      ...
      >
        ...
        <div className="flex flex-col items-center px-6 pt-6 pb-4 gap-3">
          ...
          <div className="bg-[#EEF2FB] rounded-xl px-4 py-2 flex flex-col items-center gap-0.5">
            ...
            <p className="text-[13px] font-bold text-[#0D2B6E] font-mono">
              {mid}
            </p>
          </div>
          <p className="text-[11px] text-gray-400 text-center leading-relaxed px-2">
            Display this QR at your stall or share it with customers to accept
            TNG payments.
          </p>
        </div>
        <div className="flex gap-3 px-6 pb-7">
          <button
            ...
            onClick={() => {
              if (navigator.share)
                navigator.share({
                  title: `${businessName} — TNG Merchant QR`,
                  text: mockQrPayload(businessName),
                });
            }}
          >
          ...
          <button
            ...
            onClick={() => {
              const blob = new Blob([mockQrPayload(businessName)], {
                type: "text/plain",
              });
...
export default function BusinessPage() {
  ...
  return (
    ...
    >
      {/* Hero */}
      <div
        className="w-full px-5 pt-10 pb-10"
        style={{
        ...
        <div className="max-w-lg mx-auto">
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="shrink-0 flex flex-col items-center">
              ...
              <span className="text-blue-200 text-[10px] mt-1 font-medium">
                Readiness
              </span>
            </div>
          </div>
      ...
      <div className="w-full max-w-lg mx-auto px-4 -mt-4 flex flex-col gap-4 pb-8">
        ...
        <div className="bg-white rounded-3xl p-4 shadow-md border border-[#E5EBF8]">
          <p className="text-[#0D2B6E] text-[13px] font-bold mb-3">
            Your TNG Pathway
          </p>
          <div
          ...
          >
            {pathwaySteps.map((step, i) => (
              <div
                ...
                style={{
                  borderColor: step.done ? "#1A5FD5" : "#E5EBF8",
                  backgroundColor: step.done ? "#F0F5FF" : "white",
                }}
              >
                <step.icon
                  className="w-5 h-5"
                  style={{ color: step.done ? "#1A5FD5" : "#9ca3af" }}
                />
                <span
                  className="text-[10px] font-semibold text-center leading-tight"
                  style={{ color: step.done ? "#0D2B6E" : "#9ca3af" }}
                >
                  {step.label}
                </span>
                {step.done && (
                  <span className="text-[9px] font-bold text-[#1A5FD5] bg-[#D6E4FF] px-1.5 py-0.5 rounded-full">
                    Active
                  </span>
                )}
              </div>
        ...
        <div className="bg-white rounded-3xl p-4 shadow-md border border-[#E5EBF8]">
          <div className="flex items-center justify-between mb-3">
            <p className="text-[#0D2B6E] text-[13px] font-bold">
              Onboarding Checklist
            </p>
            <span className="text-[12px] font-semibold text-[#1A5FD5]">
          ...
          <div className="flex flex-col gap-3">
            {checklist.map((item) => (
              <div key={item.key}>
                ...
                {item.key === "ssm" && !item.done && (
                  <div
                    className="ml-8 mt-2 rounded-xl px-3 py-2.5 flex items-start gap-2.5"
                    style={{
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[11px] text-amber-700 leading-relaxed">
                        SSM registration unlocks financing packages and
                        incubator programs. From{" "}
                        <span className="font-bold">RM 30</span> online at
                        ssm.com.my.
                      </p>
                      <button
                        onClick={() =>
                          router.push(
                            "/chat?prompt=" +
                              encodeURIComponent(
                                "How do I register my business with SSM in Malaysia? I'm a small business owner using TNG.",
                              ),
                          )
                        }
                        className="mt-1.5 text-[11px] font-bold text-amber-700 underline underline-offset-2"
                      >
                        Ask AlphaGrow how to get started →
                      </button>
                    </div>
                  </div>
                )}
        ...
        <div className="bg-white rounded-3xl p-4 shadow-md border border-[#E5EBF8]">
          ...
          <p className="text-[12px] text-gray-400 mb-3">
            Not a credit score — this shows how ready you are to explore
            financing later.
          </p>
          <div className="w-full h-2.5 bg-[#EEF2FB] rounded-full mb-1 overflow-hidden">
            <div
              ...
              style={{
                ...
                background: "linear-gradient(90deg, #1A5FD5, #6EE7B7)",
              }}
            />
          </div>
          <div className="flex justify-between text-[11px] text-gray-400 mb-4">
            <span>0</span>
            <span className="font-semibold text-[#1A5FD5]">
              {readinessScore} / 100
            </span>
            <span>100</span>
          </div>
